...
static std::string modeName(SortMode mode) {
    switch (mode) {
    case SortMode::NameAsc:    return "NameAsc";
    case SortMode::NameDesc:   return "NameDesc";
    case SortMode::SizeAsc:    return "SizeAsc";
    case SortMode::SizeDesc:   return "SizeDesc";
    case SortMode::TimeAsc:    return "TimeAsc";
    case SortMode::TimeDesc:   return "TimeDesc";
    case SortMode::Type:       return "Type";
    case SortMode::Extension:  return "Extension";
    }
    return "";
