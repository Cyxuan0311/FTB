...
void ThemeManager::InitializePredefinedThemes() {
    ...
    // ---- Catppuccin (faithful Mocha) ----
    FTBConfig catppuccin_theme;
    catppuccin_theme.colors_main.background = "#1e1e2e";
    catppuccin_theme.colors_main.foreground = "#cdd6f4";
    catppuccin_theme.colors_main.border = "#45475a";
    catppuccin_theme.colors_main.selection_bg = "#585b70";
    catppuccin_theme.colors_main.selection_fg = "#cdd6f4";
    catppuccin_theme.colors_files.directory = "#89b4fa";
    catppuccin_theme.colors_files.file = "#cdd6f4";
    catppuccin_theme.colors_files.executable = "#a6e3a1";
    catppuccin_theme.colors_files.link = "#f5c2e7";
    catppuccin_theme.colors_files.hidden = "#6c7086";
    catppuccin_theme.colors_files.system = "#f38ba8";
    catppuccin_theme.colors_status.background = "#313244";
    catppuccin_theme.colors_status.foreground = "#cdd6f4";
    catppuccin_theme.colors_status.border = "#45475a";
    catppuccin_theme.colors_search.background = "#1e1e2e";
    catppuccin_theme.colors_search.foreground = "#cdd6f4";
    catppuccin_theme.colors_search.border = "#89b4fa";
    catppuccin_theme.colors_dialog.background = "#1e1e2e";
    catppuccin_theme.colors_dialog.foreground = "#cdd6f4";
    catppuccin_theme.colors_dialog.border = "#89b4fa";
    catppuccin_theme.colors_syntax.keyword = "#cba6f7";
    catppuccin_theme.colors_syntax.string = "#a6e3a1";
    catppuccin_theme.colors_syntax.comment = "#585b70";
    catppuccin_theme.colors_syntax.number = "#fab387";
    catppuccin_theme.colors_syntax.function = "#89b4fa";
    catppuccin_theme.colors_syntax.type = "#f9e2af";
    catppuccin_theme.colors_syntax.operator_ = "#89dceb";
    catppuccin_theme.colors_syntax.preprocessor = "#f38ba8";
    catppuccin_theme.colors_syntax.identifier = "#cdd6f4";
    catppuccin_theme.colors_syntax.punctuation = "#6c7086";
    catppuccin_theme.colors_syntax.property = "#89dceb";
    catppuccin_theme.colors_syntax.tag = "#cba6f7";
    catppuccin_theme.colors_syntax.attribute = "#f9e2af";
    catppuccin_theme.colors_syntax.regex = "#fab387";
    catppuccin_theme.colors_syntax.decorator = "#f38ba8";
    catppuccin_theme.colors_syntax.line_number = "#313244";
    predefined_themes_["catppuccin"] = catppuccin_theme;

    // ---- GitHub Light ----
    FTBConfig github_light_theme;
    github_light_theme.colors_main.background = "#ffffff";
    github_light_theme.colors_main.foreground = "#24292f";
    github_light_theme.colors_main.border = "#d0d7de";
    github_light_theme.colors_main.selection_bg = "#ddf4ff";
    github_light_theme.colors_main.selection_fg = "#24292f";
    github_light_theme.colors_files.directory = "#0969da";
    github_light_theme.colors_files.file = "#24292f";
    github_light_theme.colors_files.executable = "#116329";
    github_light_theme.colors_files.link = "#8250df";
    github_light_theme.colors_files.hidden = "#6e7781";
    github_light_theme.colors_files.system = "#cf222e";
    github_light_theme.colors_status.background = "#f6f8fa";
    github_light_theme.colors_status.foreground = "#24292f";
    github_light_theme.colors_status.border = "#d0d7de";
    github_light_theme.colors_search.background = "#ffffff";
    github_light_theme.colors_search.foreground = "#24292f";
    github_light_theme.colors_search.border = "#0969da";
    github_light_theme.colors_dialog.background = "#ffffff";
    github_light_theme.colors_dialog.foreground = "#24292f";
    github_light_theme.colors_dialog.border = "#0969da";
    github_light_theme.colors_syntax.keyword = "#8250df";
    github_light_theme.colors_syntax.string = "#116329";
    github_light_theme.colors_syntax.comment = "#6e7781";
    github_light_theme.colors_syntax.number = "#0550ae";
    github_light_theme.colors_syntax.function = "#8250df";
    github_light_theme.colors_syntax.type = "#953800";
    github_light_theme.colors_syntax.operator_ = "#0550ae";
    github_light_theme.colors_syntax.preprocessor = "#cf222e";
    github_light_theme.colors_syntax.identifier = "#24292f";
    github_light_theme.colors_syntax.punctuation = "#6e7781";
    github_light_theme.colors_syntax.property = "#8250df";
    github_light_theme.colors_syntax.tag = "#0550ae";
    github_light_theme.colors_syntax.attribute = "#953800";
    github_light_theme.colors_syntax.regex = "#116329";
    github_light_theme.colors_syntax.decorator = "#cf222e";
    github_light_theme.colors_syntax.line_number = "#6e7781";
    predefined_themes_["github-light"] = github_light_theme;

    // ---- Hyper Snazzy ----
    FTBConfig hyper_snazzy_theme;
    hyper_snazzy_theme.colors_main.background = "#282a36";
    hyper_snazzy_theme.colors_main.foreground = "#e2e4e5";
    hyper_snazzy_theme.colors_main.border = "#343746";
    hyper_snazzy_theme.colors_main.selection_bg = "#343746";
    hyper_snazzy_theme.colors_main.selection_fg = "#e2e4e5";
    hyper_snazzy_theme.colors_files.directory = "#57c7ff";
    hyper_snazzy_theme.colors_files.file = "#e2e4e5";
    hyper_snazzy_theme.colors_files.executable = "#5af78e";
    hyper_snazzy_theme.colors_files.link = "#ff6ac1";
    hyper_snazzy_theme.colors_files.hidden = "#78787e";
    hyper_snazzy_theme.colors_files.system = "#ff5c57";
    hyper_snazzy_theme.colors_status.background = "#21222c";
    hyper_snazzy_theme.colors_status.foreground = "#e2e4e5";
    hyper_snazzy_theme.colors_status.border = "#343746";
    hyper_snazzy_theme.colors_search.background = "#282a36";
    hyper_snazzy_theme.colors_search.foreground = "#e2e4e5";
    hyper_snazzy_theme.colors_search.border = "#57c7ff";
    hyper_snazzy_theme.colors_dialog.background = "#282a36";
    hyper_snazzy_theme.colors_dialog.foreground = "#e2e4e5";
    hyper_snazzy_theme.colors_dialog.border = "#57c7ff";
    hyper_snazzy_theme.colors_syntax.keyword = "#ff6ac1";
    hyper_snazzy_theme.colors_syntax.string = "#5af78e";
    hyper_snazzy_theme.colors_syntax.comment = "#78787e";
    hyper_snazzy_theme.colors_syntax.number = "#ff9f43";
    hyper_snazzy_theme.colors_syntax.function = "#57c7ff";
    hyper_snazzy_theme.colors_syntax.type = "#f3f99d";
    hyper_snazzy_theme.colors_syntax.operator_ = "#ff6ac1";
    hyper_snazzy_theme.colors_syntax.preprocessor = "#ff5c57";
    hyper_snazzy_theme.colors_syntax.identifier = "#e2e4e5";
    hyper_snazzy_theme.colors_syntax.punctuation = "#78787e";
    hyper_snazzy_theme.colors_syntax.property = "#57c7ff";
    hyper_snazzy_theme.colors_syntax.tag = "#ff6ac1";
    hyper_snazzy_theme.colors_syntax.attribute = "#f3f99d";
    hyper_snazzy_theme.colors_syntax.regex = "#5af78e";
    hyper_snazzy_theme.colors_syntax.decorator = "#ff5c57";
    hyper_snazzy_theme.colors_syntax.line_number = "#343746";
    predefined_themes_["hyper-snazzy"] = hyper_snazzy_theme;

    // ---- Bear (warm light) ----
    FTBConfig bear_theme;
    bear_theme.colors_main.background = "#faf8f5";
    bear_theme.colors_main.foreground = "#382a2c";
    bear_theme.colors_main.border = "#e1dcd1";
    bear_theme.colors_main.selection_bg = "#e1dcd1";
    bear_theme.colors_main.selection_fg = "#382a2c";
    bear_theme.colors_files.directory = "#547db3";
    bear_theme.colors_files.file = "#382a2c";
    bear_theme.colors_files.executable = "#4a9c48";
    bear_theme.colors_files.link = "#b2577d";
    bear_theme.colors_files.hidden = "#9b9385";
    bear_theme.colors_files.system = "#ba3d3d";
    bear_theme.colors_status.background = "#ece8e0";
    bear_theme.colors_status.foreground = "#382a2c";
    bear_theme.colors_status.border = "#e1dcd1";
    bear_theme.colors_search.background = "#faf8f5";
    bear_theme.colors_search.foreground = "#382a2c";
    bear_theme.colors_search.border = "#547db3";
    bear_theme.colors_dialog.background = "#faf8f5";
    bear_theme.colors_dialog.foreground = "#382a2c";
    bear_theme.colors_dialog.border = "#547db3";
    bear_theme.colors_syntax.keyword = "#a626a4";
    bear_theme.colors_syntax.string = "#4a9c48";
    bear_theme.colors_syntax.comment = "#9b9385";
    bear_theme.colors_syntax.number = "#ba3d3d";
    bear_theme.colors_syntax.function = "#4078f2";
    bear_theme.colors_syntax.type = "#c18401";
    bear_theme.colors_syntax.operator_ = "#4078f2";
    bear_theme.colors_syntax.preprocessor = "#ba3d3d";
    bear_theme.colors_syntax.identifier = "#382a2c";
    bear_theme.colors_syntax.punctuation = "#9b9385";
    bear_theme.colors_syntax.property = "#4078f2";
    bear_theme.colors_syntax.tag = "#a626a4";
    bear_theme.colors_syntax.attribute = "#c18401";
    bear_theme.colors_syntax.regex = "#4a9c48";
    bear_theme.colors_syntax.decorator = "#ba3d3d";
    bear_theme.colors_syntax.line_number = "#9b9385";
    predefined_themes_["bear"] = bear_theme;

    // ---- Oceanic Next ----
    FTBConfig oceanic_next_theme;
    oceanic_next_theme.colors_main.background = "#1b2b34";
    oceanic_next_theme.colors_main.foreground = "#c0c5ce";
    oceanic_next_theme.colors_main.border = "#293c48";
    oceanic_next_theme.colors_main.selection_bg = "#293c48";
    oceanic_next_theme.colors_main.selection_fg = "#c0c5ce";
    oceanic_next_theme.colors_files.directory = "#6699cc";
    oceanic_next_theme.colors_files.file = "#c0c5ce";
    oceanic_next_theme.colors_files.executable = "#99c794";
    oceanic_next_theme.colors_files.link = "#c594c5";
    oceanic_next_theme.colors_files.hidden = "#4c5a66";
    oceanic_next_theme.colors_files.system = "#ec5f67";
    oceanic_next_theme.colors_status.background = "#12222b";
    oceanic_next_theme.colors_status.foreground = "#c0c5ce";
    oceanic_next_theme.colors_status.border = "#293c48";
    oceanic_next_theme.colors_search.background = "#1b2b34";
    oceanic_next_theme.colors_search.foreground = "#c0c5ce";
    oceanic_next_theme.colors_search.border = "#6699cc";
    oceanic_next_theme.colors_dialog.background = "#1b2b34";
    oceanic_next_theme.colors_dialog.foreground = "#c0c5ce";
    oceanic_next_theme.colors_dialog.border = "#6699cc";
    oceanic_next_theme.colors_syntax.keyword = "#c594c5";
    oceanic_next_theme.colors_syntax.string = "#99c794";
    oceanic_next_theme.colors_syntax.comment = "#4c5a66";
    oceanic_next_theme.colors_syntax.number = "#f99157";
    oceanic_next_theme.colors_syntax.function = "#6699cc";
    oceanic_next_theme.colors_syntax.type = "#fac863";
    oceanic_next_theme.colors_syntax.operator_ = "#5fb3b3";
    oceanic_next_theme.colors_syntax.preprocessor = "#ec5f67";
    oceanic_next_theme.colors_syntax.identifier = "#c0c5ce";
    oceanic_next_theme.colors_syntax.punctuation = "#4c5a66";
    oceanic_next_theme.colors_syntax.property = "#5fb3b3";
    oceanic_next_theme.colors_syntax.tag = "#c594c5";
    oceanic_next_theme.colors_syntax.attribute = "#fac863";
    oceanic_next_theme.colors_syntax.regex = "#f99157";
    oceanic_next_theme.colors_syntax.decorator = "#ec5f67";
    oceanic_next_theme.colors_syntax.line_number = "#293c48";
    predefined_themes_["oceanic-next"] = oceanic_next_theme;

    // ---- Cyberdream (green/cyan cyberpunk) ----
    FTBConfig cyberdream_theme;
    cyberdream_theme.colors_main.background = "#0a0a0f";
    cyberdream_theme.colors_main.foreground = "#cdd6f4";
    cyberdream_theme.colors_main.border = "#1a1a2e";
    cyberdream_theme.colors_main.selection_bg = "#1a1a2e";
    cyberdream_theme.colors_main.selection_fg = "#cdd6f4";
    cyberdream_theme.colors_files.directory = "#00d4aa";
    cyberdream_theme.colors_files.file = "#cdd6f4";
    cyberdream_theme.colors_files.executable = "#00ff9f";
    cyberdream_theme.colors_files.link = "#f7768e";
    cyberdream_theme.colors_files.hidden = "#3b3b5c";
    cyberdream_theme.colors_files.system = "#ff0055";
    cyberdream_theme.colors_status.background = "#12121c";
    cyberdream_theme.colors_status.foreground = "#cdd6f4";
    cyberdream_theme.colors_status.border = "#1a1a2e";
    cyberdream_theme.colors_search.background = "#0a0a0f";
    cyberdream_theme.colors_search.foreground = "#cdd6f4";
    cyberdream_theme.colors_search.border = "#00d4aa";
    cyberdream_theme.colors_dialog.background = "#0a0a0f";
    cyberdream_theme.colors_dialog.foreground = "#cdd6f4";
    cyberdream_theme.colors_dialog.border = "#00d4aa";
    cyberdream_theme.colors_syntax.keyword = "#ff7edb";
    cyberdream_theme.colors_syntax.string = "#00ff9f";
    cyberdream_theme.colors_syntax.comment = "#3b3b5c";
    cyberdream_theme.colors_syntax.number = "#ffaa00";
    cyberdream_theme.colors_syntax.function = "#00d4aa";
    cyberdream_theme.colors_syntax.type = "#ffee99";
    cyberdream_theme.colors_syntax.operator_ = "#ff7edb";
    cyberdream_theme.colors_syntax.preprocessor = "#ff0055";
    cyberdream_theme.colors_syntax.identifier = "#cdd6f4";
    cyberdream_theme.colors_syntax.punctuation = "#3b3b5c";
    cyberdream_theme.colors_syntax.property = "#00d4aa";
    cyberdream_theme.colors_syntax.tag = "#ff7edb";
    cyberdream_theme.colors_syntax.attribute = "#ffee99";
    cyberdream_theme.colors_syntax.regex = "#00ff9f";
    cyberdream_theme.colors_syntax.decorator = "#ff0055";
    cyberdream_theme.colors_syntax.line_number = "#1a1a2e";
    predefined_themes_["cyberdream"] = cyberdream_theme;

    // ---- Neon Night (purple/magenta neon) ----
    FTBConfig neon_night_theme;
    neon_night_theme.colors_main.background = "#0f0f1a";
    neon_night_theme.colors_main.foreground = "#e0e0ff";
    neon_night_theme.colors_main.border = "#1c1c32";
    neon_night_theme.colors_main.selection_bg = "#2a1a4e";
    neon_night_theme.colors_main.selection_fg = "#e0e0ff";
    neon_night_theme.colors_files.directory = "#7c3fc4";
    neon_night_theme.colors_files.file = "#e0e0ff";
    neon_night_theme.colors_files.executable = "#00ffaa";
    neon_night_theme.colors_files.link = "#ff66cc";
    neon_night_theme.colors_files.hidden = "#4a4a6a";
    neon_night_theme.colors_files.system = "#ff3355";
    neon_night_theme.colors_status.background = "#1a1a30";
    neon_night_theme.colors_status.foreground = "#e0e0ff";
    neon_night_theme.colors_status.border = "#1c1c32";
    neon_night_theme.colors_search.background = "#0f0f1a";
    neon_night_theme.colors_search.foreground = "#e0e0ff";
    neon_night_theme.colors_search.border = "#7c3fc4";
    neon_night_theme.colors_dialog.background = "#0f0f1a";
    neon_night_theme.colors_dialog.foreground = "#e0e0ff";
    neon_night_theme.colors_dialog.border = "#7c3fc4";
    neon_night_theme.colors_syntax.keyword = "#ff66cc";
    neon_night_theme.colors_syntax.string = "#00ffaa";
    neon_night_theme.colors_syntax.comment = "#4a4a6a";
    neon_night_theme.colors_syntax.number = "#ffaa44";
    neon_night_theme.colors_syntax.function = "#7c3fc4";
    neon_night_theme.colors_syntax.type = "#ffcc66";
    neon_night_theme.colors_syntax.operator_ = "#66ccff";
    neon_night_theme.colors_syntax.preprocessor = "#ff3355";
    neon_night_theme.colors_syntax.identifier = "#e0e0ff";
    neon_night_theme.colors_syntax.punctuation = "#4a4a6a";
    neon_night_theme.colors_syntax.property = "#7c3fc4";
    neon_night_theme.colors_syntax.tag = "#ff66cc";
    neon_night_theme.colors_syntax.attribute = "#ffcc66";
    neon_night_theme.colors_syntax.regex = "#00ffaa";
    neon_night_theme.colors_syntax.decorator = "#ff3355";
    neon_night_theme.colors_syntax.line_number = "#1c1c32";
    predefined_themes_["neon-night"] = neon_night_theme;

    // ---- Jellybeans (rich warm dark) ----
    FTBConfig jellybeans_theme;
    jellybeans_theme.colors_main.background = "#151515";
    jellybeans_theme.colors_main.foreground = "#d8d8d8";
    jellybeans_theme.colors_main.border = "#242424";
    jellybeans_theme.colors_main.selection_bg = "#353535";
    jellybeans_theme.colors_main.selection_fg = "#d8d8d8";
    jellybeans_theme.colors_files.directory = "#53b6b6";
    jellybeans_theme.colors_files.file = "#d8d8d8";
    jellybeans_theme.colors_files.executable = "#8faa66";
    jellybeans_theme.colors_files.link = "#e18c5a";
    jellybeans_theme.colors_files.hidden = "#5a5a5a";
    jellybeans_theme.colors_files.system = "#cf6a4c";
    jellybeans_theme.colors_status.background = "#1c1c1c";
    jellybeans_theme.colors_status.foreground = "#d8d8d8";
    jellybeans_theme.colors_status.border = "#242424";
    jellybeans_theme.colors_search.background = "#151515";
    jellybeans_theme.colors_search.foreground = "#d8d8d8";
    jellybeans_theme.colors_search.border = "#53b6b6";
    jellybeans_theme.colors_dialog.background = "#151515";
    jellybeans_theme.colors_dialog.foreground = "#d8d8d8";
    jellybeans_theme.colors_dialog.border = "#53b6b6";
    jellybeans_theme.colors_syntax.keyword = "#cf6a4c";
    jellybeans_theme.colors_syntax.string = "#8faa66";
    jellybeans_theme.colors_syntax.comment = "#5a5a5a";
    jellybeans_theme.colors_syntax.number = "#6d8bb7";
    jellybeans_theme.colors_syntax.function = "#e18c5a";
    jellybeans_theme.colors_syntax.type = "#e8d68a";
    jellybeans_theme.colors_syntax.operator_ = "#53b6b6";
    jellybeans_theme.colors_syntax.preprocessor = "#cf6a4c";
    jellybeans_theme.colors_syntax.identifier = "#d8d8d8";
    jellybeans_theme.colors_syntax.punctuation = "#5a5a5a";
    jellybeans_theme.colors_syntax.property = "#53b6b6";
    jellybeans_theme.colors_syntax.tag = "#cf6a4c";
    jellybeans_theme.colors_syntax.attribute = "#e8d68a";
    jellybeans_theme.colors_syntax.regex = "#8faa66";
    jellybeans_theme.colors_syntax.decorator = "#a54f3a";
    jellybeans_theme.colors_syntax.line_number = "#353535";
    predefined_themes_["jellybeans"] = jellybeans_theme;

    // ---- Spacegray (cool gray) ----
    FTBConfig spacegray_theme;
    spacegray_theme.colors_main.background = "#1d1f21";
    spacegray_theme.colors_main.foreground = "#c5c8c6";
    spacegray_theme.colors_main.border = "#282a2e";
    spacegray_theme.colors_main.selection_bg = "#373b41";
    spacegray_theme.colors_main.selection_fg = "#c5c8c6";
    spacegray_theme.colors_files.directory = "#81a2be";
    spacegray_theme.colors_files.file = "#c5c8c6";
    spacegray_theme.colors_files.executable = "#b5bd68";
    spacegray_theme.colors_files.link = "#b294bb";
    spacegray_theme.colors_files.hidden = "#707880";
    spacegray_theme.colors_files.system = "#cc6666";
    spacegray_theme.colors_status.background = "#151718";
    spacegray_theme.colors_status.foreground = "#c5c8c6";
    spacegray_theme.colors_status.border = "#282a2e";
    spacegray_theme.colors_search.background = "#1d1f21";
    spacegray_theme.colors_search.foreground = "#c5c8c6";
    spacegray_theme.colors_search.border = "#81a2be";
    spacegray_theme.colors_dialog.background = "#1d1f21";
    spacegray_theme.colors_dialog.foreground = "#c5c8c6";
    spacegray_theme.colors_dialog.border = "#81a2be";
    spacegray_theme.colors_syntax.keyword = "#b294bb";
    spacegray_theme.colors_syntax.string = "#b5bd68";
    spacegray_theme.colors_syntax.comment = "#707880";
    spacegray_theme.colors_syntax.number = "#de935f";
    spacegray_theme.colors_syntax.function = "#81a2be";
    spacegray_theme.colors_syntax.type = "#f0c674";
    spacegray_theme.colors_syntax.operator_ = "#8abeb7";
    spacegray_theme.colors_syntax.preprocessor = "#cc6666";
    spacegray_theme.colors_syntax.identifier = "#c5c8c6";
    spacegray_theme.colors_syntax.punctuation = "#707880";
    spacegray_theme.colors_syntax.property = "#81a2be";
    spacegray_theme.colors_syntax.tag = "#b294bb";
    spacegray_theme.colors_syntax.attribute = "#f0c674";
    spacegray_theme.colors_syntax.regex = "#b5bd68";
    spacegray_theme.colors_syntax.decorator = "#cc6666";
    spacegray_theme.colors_syntax.line_number = "#282a2e";
    predefined_themes_["spacegray"] = spacegray_theme;

    // ---- Supreme (ultra dark, OLED-friendly) ----
    FTBConfig supreme_theme;
    supreme_theme.colors_main.background = "#000000";
    supreme_theme.colors_main.foreground = "#ffffff";
    supreme_theme.colors_main.border = "#1a1a1a";
    supreme_theme.colors_main.selection_bg = "#2a2a2a";
    supreme_theme.colors_main.selection_fg = "#ffffff";
    supreme_theme.colors_files.directory = "#6eb0f0";
    supreme_theme.colors_files.file = "#ffffff";
    supreme_theme.colors_files.executable = "#70c070";
    supreme_theme.colors_files.link = "#f090c0";
    supreme_theme.colors_files.hidden = "#505050";
    supreme_theme.colors_files.system = "#f05050";
    supreme_theme.colors_status.background = "#0d0d0d";
    supreme_theme.colors_status.foreground = "#ffffff";
    supreme_theme.colors_status.border = "#1a1a1a";
    supreme_theme.colors_search.background = "#000000";
    supreme_theme.colors_search.foreground = "#ffffff";
    supreme_theme.colors_search.border = "#6eb0f0";
    supreme_theme.colors_dialog.background = "#000000";
    supreme_theme.colors_dialog.foreground = "#ffffff";
    supreme_theme.colors_dialog.border = "#6eb0f0";
    supreme_theme.colors_syntax.keyword = "#f090c0";
    supreme_theme.colors_syntax.string = "#70c070";
    supreme_theme.colors_syntax.comment = "#505050";
    supreme_theme.colors_syntax.number = "#d0b060";
    supreme_theme.colors_syntax.function = "#6eb0f0";
    supreme_theme.colors_syntax.type = "#f0d070";
    supreme_theme.colors_syntax.operator_ = "#70c0c0";
    supreme_theme.colors_syntax.preprocessor = "#f05050";
    supreme_theme.colors_syntax.identifier = "#ffffff";
    supreme_theme.colors_syntax.punctuation = "#505050";
    supreme_theme.colors_syntax.property = "#6eb0f0";
    supreme_theme.colors_syntax.tag = "#f090c0";
    supreme_theme.colors_syntax.attribute = "#f0d070";
    supreme_theme.colors_syntax.regex = "#70c070";
    supreme_theme.colors_syntax.decorator = "#f05050";
    supreme_theme.colors_syntax.line_number = "#1a1a1a";
    predefined_themes_["supreme"] = supreme_theme;

    // ---- Rebecca (purple-based dark) ----
    FTBConfig rebecca_theme;
    rebecca_theme.colors_main.background = "#2a1e3c";
    rebecca_theme.colors_main.foreground = "#e0d2f0";
    rebecca_theme.colors_main.border = "#3a2a52";
    rebecca_theme.colors_main.selection_bg = "#4a3660";
    rebecca_theme.colors_main.selection_fg = "#e0d2f0";
    rebecca_theme.colors_files.directory = "#a881ff";
    rebecca_theme.colors_files.file = "#e0d2f0";
    rebecca_theme.colors_files.executable = "#6ddf6d";
    rebecca_theme.colors_files.link = "#ff8ac4";
    rebecca_theme.colors_files.hidden = "#6e5480";
    rebecca_theme.colors_files.system = "#ef5350";
    rebecca_theme.colors_status.background = "#1e1530";
    rebecca_theme.colors_status.foreground = "#e0d2f0";
    rebecca_theme.colors_status.border = "#3a2a52";
    rebecca_theme.colors_search.background = "#2a1e3c";
    rebecca_theme.colors_search.foreground = "#e0d2f0";
    rebecca_theme.colors_search.border = "#a881ff";
    rebecca_theme.colors_dialog.background = "#2a1e3c";
    rebecca_theme.colors_dialog.foreground = "#e0d2f0";
    rebecca_theme.colors_dialog.border = "#a881ff";
    rebecca_theme.colors_syntax.keyword = "#ff8ac4";
    rebecca_theme.colors_syntax.string = "#6ddf6d";
    rebecca_theme.colors_syntax.comment = "#6e5480";
    rebecca_theme.colors_syntax.number = "#ffcc66";
    rebecca_theme.colors_syntax.function = "#a881ff";
    rebecca_theme.colors_syntax.type = "#ffd47a";
    rebecca_theme.colors_syntax.operator_ = "#7fc7ff";
    rebecca_theme.colors_syntax.preprocessor = "#ef5350";
    rebecca_theme.colors_syntax.identifier = "#e0d2f0";
    rebecca_theme.colors_syntax.punctuation = "#6e5480";
    rebecca_theme.colors_syntax.property = "#a881ff";
    rebecca_theme.colors_syntax.tag = "#ff8ac4";
    rebecca_theme.colors_syntax.attribute = "#ffd47a";
    rebecca_theme.colors_syntax.regex = "#6ddf6d";
    rebecca_theme.colors_syntax.decorator = "#ef5350";
    rebecca_theme.colors_syntax.line_number = "#3a2a52";
    predefined_themes_["rebecca"] = rebecca_theme;

    // ---- Bluloco (blue/orange accent) ----
    FTBConfig bluloco_theme;
    bluloco_theme.colors_main.background = "#1b1e28";
    bluloco_theme.colors_main.foreground = "#abb9d6";
    bluloco_theme.colors_main.border = "#252836";
    bluloco_theme.colors_main.selection_bg = "#303348";
    bluloco_theme.colors_main.selection_fg = "#abb9d6";
    bluloco_theme.colors_files.directory = "#5799f7";
    bluloco_theme.colors_files.file = "#abb9d6";
    bluloco_theme.colors_files.executable = "#5aa794";
    bluloco_theme.colors_files.link = "#e27e8d";
    bluloco_theme.colors_files.hidden = "#5b637b";
    bluloco_theme.colors_files.system = "#e9636b";
    bluloco_theme.colors_status.background = "#131620";
    bluloco_theme.colors_status.foreground = "#abb9d6";
    bluloco_theme.colors_status.border = "#252836";
    bluloco_theme.colors_search.background = "#1b1e28";
    bluloco_theme.colors_search.foreground = "#abb9d6";
    bluloco_theme.colors_search.border = "#5799f7";
    bluloco_theme.colors_dialog.background = "#1b1e28";
    bluloco_theme.colors_dialog.foreground = "#abb9d6";
    bluloco_theme.colors_dialog.border = "#5799f7";
    bluloco_theme.colors_syntax.keyword = "#e27e8d";
    bluloco_theme.colors_syntax.string = "#5aa794";
    bluloco_theme.colors_syntax.comment = "#5b637b";
    bluloco_theme.colors_syntax.number = "#f9b454";
    bluloco_theme.colors_syntax.function = "#a3b8ff";
    bluloco_theme.colors_syntax.type = "#f9b454";
    bluloco_theme.colors_syntax.operator_ = "#69b0d9";
    bluloco_theme.colors_syntax.preprocessor = "#e9636b";
    bluloco_theme.colors_syntax.identifier = "#abb9d6";
    bluloco_theme.colors_syntax.punctuation = "#5b637b";
    bluloco_theme.colors_syntax.property = "#5799f7";
    bluloco_theme.colors_syntax.tag = "#e27e8d";
    bluloco_theme.colors_syntax.attribute = "#f9b454";
    bluloco_theme.colors_syntax.regex = "#5aa794";
    bluloco_theme.colors_syntax.decorator = "#e9636b";
    bluloco_theme.colors_syntax.line_number = "#252836";
    predefined_themes_["bluloco"] = bluloco_theme;

    // ---- Seoul256 Light (calm light) ----
    FTBConfig seoul256_light_theme;
    seoul256_light_theme.colors_main.background = "#eaeaea";
    seoul256_light_theme.colors_main.foreground = "#4c4c4c";
    seoul256_light_theme.colors_main.border = "#d0d0d0";
    seoul256_light_theme.colors_main.selection_bg = "#d0d0d0";
    seoul256_light_theme.colors_main.selection_fg = "#4c4c4c";
    seoul256_light_theme.colors_files.directory = "#4e7090";
    seoul256_light_theme.colors_files.file = "#4c4c4c";
    seoul256_light_theme.colors_files.executable = "#587050";
    seoul256_light_theme.colors_files.link = "#8a6070";
    seoul256_light_theme.colors_files.hidden = "#9e9e9e";
    seoul256_light_theme.colors_files.system = "#8c4c4c";
    seoul256_light_theme.colors_status.background = "#dcdcdc";
    seoul256_light_theme.colors_status.foreground = "#4c4c4c";
    seoul256_light_theme.colors_status.border = "#d0d0d0";
    seoul256_light_theme.colors_search.background = "#eaeaea";
    seoul256_light_theme.colors_search.foreground = "#4c4c4c";
    seoul256_light_theme.colors_search.border = "#4e7090";
    seoul256_light_theme.colors_dialog.background = "#eaeaea";
    seoul256_light_theme.colors_dialog.foreground = "#4c4c4c";
    seoul256_light_theme.colors_dialog.border = "#4e7090";
    seoul256_light_theme.colors_syntax.keyword = "#8a6070";
    seoul256_light_theme.colors_syntax.string = "#587050";
    seoul256_light_theme.colors_syntax.comment = "#9e9e9e";
    seoul256_light_theme.colors_syntax.number = "#8c4c4c";
    seoul256_light_theme.colors_syntax.function = "#4e7090";
    seoul256_light_theme.colors_syntax.type = "#7a6040";
    seoul256_light_theme.colors_syntax.operator_ = "#4e7090";
    seoul256_light_theme.colors_syntax.preprocessor = "#8c4c4c";
    seoul256_light_theme.colors_syntax.identifier = "#4c4c4c";
    seoul256_light_theme.colors_syntax.punctuation = "#9e9e9e";
    seoul256_light_theme.colors_syntax.property = "#4e7090";
    seoul256_light_theme.colors_syntax.tag = "#8a6070";
    seoul256_light_theme.colors_syntax.attribute = "#7a6040";
    seoul256_light_theme.colors_syntax.regex = "#587050";
    seoul256_light_theme.colors_syntax.decorator = "#8c4c4c";
    seoul256_light_theme.colors_syntax.line_number = "#9e9e9e";
    predefined_themes_["seoul256-light"] = seoul256_light_theme;

    // ---- Snazzy (fresh dark) ----
    FTBConfig snazzy_theme;
    snazzy_theme.colors_main.background = "#1e2127";
    snazzy_theme.colors_main.foreground = "#ebece6";
    snazzy_theme.colors_main.border = "#2a2e36";
    snazzy_theme.colors_main.selection_bg = "#353a44";
    snazzy_theme.colors_main.selection_fg = "#ebece6";
    snazzy_theme.colors_files.directory = "#57c7ff";
    snazzy_theme.colors_files.file = "#ebece6";
    snazzy_theme.colors_files.executable = "#5af78e";
    snazzy_theme.colors_files.link = "#ff6ac1";
    snazzy_theme.colors_files.hidden = "#7a7f8a";
    snazzy_theme.colors_files.system = "#ff5c57";
    snazzy_theme.colors_status.background = "#282c35";
    snazzy_theme.colors_status.foreground = "#ebece6";
    snazzy_theme.colors_status.border = "#2a2e36";
    snazzy_theme.colors_search.background = "#1e2127";
    snazzy_theme.colors_search.foreground = "#ebece6";
    snazzy_theme.colors_search.border = "#57c7ff";
    snazzy_theme.colors_dialog.background = "#1e2127";
    snazzy_theme.colors_dialog.foreground = "#ebece6";
    snazzy_theme.colors_dialog.border = "#57c7ff";
    snazzy_theme.colors_syntax.keyword = "#ff6ac1";
    snazzy_theme.colors_syntax.string = "#5af78e";
    snazzy_theme.colors_syntax.comment = "#7a7f8a";
    snazzy_theme.colors_syntax.number = "#ff9f43";
    snazzy_theme.colors_syntax.function = "#57c7ff";
    snazzy_theme.colors_syntax.type = "#f3f99d";
    snazzy_theme.colors_syntax.operator_ = "#9aedfe";
    snazzy_theme.colors_syntax.preprocessor = "#ff5c57";
    snazzy_theme.colors_syntax.identifier = "#ebece6";
    snazzy_theme.colors_syntax.punctuation = "#7a7f8a";
    snazzy_theme.colors_syntax.property = "#57c7ff";
    snazzy_theme.colors_syntax.tag = "#ff6ac1";
    snazzy_theme.colors_syntax.attribute = "#f3f99d";
    snazzy_theme.colors_syntax.regex = "#5af78e";
    snazzy_theme.colors_syntax.decorator = "#ff5c57";
    snazzy_theme.colors_syntax.line_number = "#2a2e36";
    predefined_themes_["snazzy"] = snazzy_theme;

    // ---- Noctis (calming blue-gray) ----
    FTBConfig noctis_theme;
    noctis_theme.colors_main.background = "#1b2029";
    noctis_theme.colors_main.foreground = "#c5ccd6";
    noctis_theme.colors_main.border = "#262d39";
    noctis_theme.colors_main.selection_bg = "#313a47";
    noctis_theme.colors_main.selection_fg = "#c5ccd6";
    noctis_theme.colors_files.directory = "#5ba3e6";
    noctis_theme.colors_files.file = "#c5ccd6";
    noctis_theme.colors_files.executable = "#6cc06c";
    noctis_theme.colors_files.link = "#c87db0";
    noctis_theme.colors_files.hidden = "#5a6270";
    noctis_theme.colors_files.system = "#e66565";
    noctis_theme.colors_status.background = "#151a22";
    noctis_theme.colors_status.foreground = "#c5ccd6";
    noctis_theme.colors_status.border = "#262d39";
    noctis_theme.colors_search.background = "#1b2029";
    noctis_theme.colors_search.foreground = "#c5ccd6";
    noctis_theme.colors_search.border = "#5ba3e6";
    noctis_theme.colors_dialog.background = "#1b2029";
    noctis_theme.colors_dialog.foreground = "#c5ccd6";
    noctis_theme.colors_dialog.border = "#5ba3e6";
    noctis_theme.colors_syntax.keyword = "#c87db0";
    noctis_theme.colors_syntax.string = "#6cc06c";
    noctis_theme.colors_syntax.comment = "#5a6270";
    noctis_theme.colors_syntax.number = "#e6b86e";
    noctis_theme.colors_syntax.function = "#5ba3e6";
    noctis_theme.colors_syntax.type = "#c5b87d";
    noctis_theme.colors_syntax.operator_ = "#7ab0c5";
    noctis_theme.colors_syntax.preprocessor = "#e66565";
    noctis_theme.colors_syntax.identifier = "#c5ccd6";
    noctis_theme.colors_syntax.punctuation = "#5a6270";
    noctis_theme.colors_syntax.property = "#5ba3e6";
    noctis_theme.colors_syntax.tag = "#c87db0";
    noctis_theme.colors_syntax.attribute = "#c5b87d";
    noctis_theme.colors_syntax.regex = "#6cc06c";
